(() => {
  ...
  const creditCardMask = document.querySelector('.billing-card-mask');
  const expiryDateMask = document.querySelector('.billing-expiry-date-mask');
  const cvvMask = document.querySelector('.billing-cvv-mask');
