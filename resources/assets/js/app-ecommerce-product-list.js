...
$(() => {
  ...
  if (dt_product_table.length) {
    const dt_products = dt_product_table.DataTable({
      ...
      columnDefs: [
        ...
        },
        {
          ...
          render: (data, type, full, meta) => {
            ...
            const $id = full.id;
            const $product_brand = full.product_brand;
            ...
            const $row_output = `<div class="d-flex justify-content-start align-items-center product-name"><div class="avatar-wrapper"><div class="avatar avatar me-2 rounded-2 bg-label-secondary">${$output}</div></div><div class="d-flex flex-column"><h6 class="text-body text-nowrap mb-0">${$name}</h6><small class="text-muted text-truncate d-none d-sm-block">${$product_brand}</small></div></div>`;
            return $row_output;
          },
        },
        {
          ...
          render: (data, type, full, meta) => {
            const $category = categoryObj[full.category].title;
        ...
        },
        {
          ...
          render: (data, type, full, meta) => {
            const $stock = full.stock;
            const stockSwitchObj = {
              Out_of_Stock:
            ...
            }<span class="d-none">${stockObj[$stock].title}</span></span>`;
          },
        },
        {
          // Sku
        ...
        this.api()
          ...
          .every(function () {
            ...
            column
              ...
              .each((d, j) => {
                select.append(
                  `<option value="${statusObj[d].title}">${statusObj[d].title}</option>`,
                );
              });
          });
        ...
        this.api()
          ...
          .every(function () {
            ...
            column
              ...
              .each((d, j) => {
                select.append(
                  `<option value="${categoryObj[d].title}">${categoryObj[d].title}</option>`,
                );
              });
          });
