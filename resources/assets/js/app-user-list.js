      ...
      columnDefs: [
        ...
        },
        {
          ...
          render: (data, type, full, meta) => {
            ...
            const $row_output = `<div class="d-flex justify-content-start align-items-center user-name"><div class="avatar-wrapper"><div class="avatar me-3">${$output}</div></div><div class="d-flex flex-column"><a href="${userView}" class="text-body text-truncate"><span class="fw-medium">${$name}</span></a><small class="text-muted">${$email}</small></div></div>`;
            return $row_output;
          },
        },
        {
