...
$(() => {
  ...
  if (dt_order_table.length) {
    const dt_products = dt_order_table.DataTable({
      ...
      columnDefs: [
        ...
        },
        {
          ...
          render: (data, type, full, meta) => {
            ...
            const $row_output = `<a href=" ${baseUrl}app/ecommerce/order/details"><span>#${$order_id}</span></a>`;
            return $row_output;
          },
        },
        {
        ...
        },
        {
          ...
          render: (data, type, full, meta) => {
            ...
            // Creates full output for row
            const $row_output = `<div class="d-flex justify-content-start align-items-center order-name text-nowrap"><div class="avatar-wrapper"><div class="avatar me-2">${$output}</div></div><div class="d-flex flex-column"><h6 class="m-0"><a href="${baseUrl}pages/profile-user" class="text-body">${$name}</a></h6><small class="text-muted">${$email}</small></div></div>`;
            return $row_output;
          },
        },
        {
          ...
          render: (data, type, full, meta) => {
            ...
            const $paymentObj = paymentObj[$payment];
            if ($paymentObj) {
        ...
        },
        {
          ...
          render: (data, type, full, meta) => {
            ...
            let $method_number = full.method_number;
        ...
        },
        {
          ...
          orderable: false,
          render: (data, type, full, meta) =>
            `<div class="d-flex justify-content-sm-center align-items-sm-center"><button class="btn btn-sm btn-icon dropdown-toggle hide-arrow" data-bs-toggle="dropdown"><i class="ti ti-dots-vertical"></i></button><div class="dropdown-menu dropdown-menu-end m-0"><a href=" ${baseUrl}app/ecommerce/order/details" class="dropdown-item">View</a><a href="javascript:0;" class="dropdown-item delete-record">Delete</a></div></div>`,
        },
      ],
              ...
              exportOptions: {
                ...
                format: {
                  body: (inner, coldex, rowdex) => {
                    ...
                    let result = "";
                    $.each(el, (index, item) => {
                      if (item.classList?.contains("order-name")) {
