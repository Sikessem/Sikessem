(() => {
  ...
  const menu1Btn = document.querySelector('#menu-1-toggle-collapsed');
  ...
  const menu5Btn = document.querySelector('#menu-5-toggle-collapsed');
  if (menu5) {
    new Menu(menu5, {
      animate: false,
    });
  ...
  const menu7Btn = document.querySelector('#menu-7-toggle-collapsed');
  if (menu7) {
    new Menu(menu7, {
      accordion: false,
    });
  ...
  const menu9Btn = document.querySelector('#menus-9-toggle-collapsed');
  if (menus9List) {
  ...
  const menu10Btn = document.querySelector('#menus-10-toggle-collapsed');
  if (menus10List) {
  ...
  const menu12Btn = document.querySelector('#menus-12-toggle-collapsed');
  if (menus12List) {
