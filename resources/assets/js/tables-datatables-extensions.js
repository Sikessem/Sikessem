      ...
      columnDefs: [
        ...
        },
        {
          ...
          render: (data, type, full, meta) => {
            ...
            const $row_output = `<div class="d-flex justify-content-start align-items-center"><div class="avatar-wrapper"><div class="avatar me-2">${$output}</div></div><div class="d-flex flex-column"><span class="emp_name text-truncate">${$name}</span><small class="emp_post text-truncate text-muted">${$post}</small></div></div>`;
            return $row_output;
          },
