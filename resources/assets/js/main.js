          ...
          .typeahead(
            ...
            // Pages
            {
              ...
              templates: {
                ...
                suggestion: ({ url, icon, name }) =>
                  `<a href="${baseUrl}${url}"><div><i class="ti ${icon} me-2"></i><span class="align-middle">${name}</span></div></a>`,
                notFound:
            ...
            // Files
            {
              ...
              templates: {
                ...
                suggestion: ({ src, name, subtitle, meta }) =>
                  `<a href="javascript:;"><div class="d-flex w-50"><img class="me-3" src="${assetsPath}${src}" alt="${name}" height="32"><div class="w-75"><h6 class="mb-0">${name}</h6><small class="text-muted">${subtitle}</small></div></div><small class="text-muted">${meta}</small></a>`,
                notFound:
                  '<div class="not-found px-3 py-2">' +
            ...
            // Members
            {
              ...
              templates: {
                ...
                suggestion: ({ name, src, subtitle }) =>
                  `<a href="${baseUrl}app/user/view/account"><div class="d-flex align-items-center"><img class="rounded-circle me-3" src="${assetsPath}${src}" alt="${name}" height="32"><div class="user-info"><h6 class="mb-0">${name}</h6><small class="text-muted">${subtitle}</small></div></div></a>`,
                notFound:
                  '<div class="not-found px-3 py-2">' +
